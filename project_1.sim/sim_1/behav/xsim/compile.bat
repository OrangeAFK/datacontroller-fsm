...
REM
REM Generated by Vivado on Mon Oct 13 15:31:00 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fsm_deterministic_vlog.prj"
call xvlog  --incr --relax -prj tb_fsm_deterministic_vlog.prj -log xvlog.log
